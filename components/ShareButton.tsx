...
function ShareModal({ job, isOpen, onClose }: { job: Job; isOpen: boolean; onClose: () => void }) {
...
export default function ShareButton({ job }: ShareButtonProps) {
  ...
  return (
    <>
      ...
      <ShareModal job={job} isOpen={isShareModalOpen} onClose={() => setIsShareModalOpen(false)} />
    </>
  );
}